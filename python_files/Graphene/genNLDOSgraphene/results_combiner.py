...
def combine_results():
    ...
    result_files = [f for f in os.listdir('tmp') if f.startswith(
        'results_chunk_') and f.endswith('.npy')]
    ...
    print(
        f"Combined results saved. Shape of each output: {final_results.shape[1:]}")
