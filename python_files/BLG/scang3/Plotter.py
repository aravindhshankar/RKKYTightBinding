...
path_to_dump = '/Users/aravindhswaminathan/Documents/GitHub/RKKYTightBinding/python_files/Output/scang3/'
path_to_fig = '/Users/aravindhswaminathan/Documents/GitHub/RKKYTightBinding/python_files/Figures/scang3'
...
for i, job_idx in enumerate(jobarray):
    ...
    for j, ax in enumerate(axlist):
        ax[0].plot(omegavals, LDOS.T[j], '.-', c=col, label = f'g3 = {g3val}')
        # ax[0].plot(omegavals, analytic, '--', c=col)
        ax[1].loglog(omegavals[omegavals<1],LDOS.T[j][omegavals<1],c=col, label = f'g3 = {g3val}')

        ax[0].set_xlabel('omega')
        ax[0].set_title(f'BLG scan gamma3 LDOS site [{j},{j}] ')
        ax[0].legend()
