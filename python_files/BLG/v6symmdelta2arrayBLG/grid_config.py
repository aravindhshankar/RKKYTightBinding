...
rvals = np.array([0,2,4,8,16,32,64,128,256,400,512,800,1024,1600,2048,4096])
...
NUMGS = 3 #size of the array returned by helper_mp 
...
def helper_mp(r, omega):
    ...
    def call_int(kx) : 
        ...
        return np.array((Gkx[0,0], Gkx[0,1], Gkx[0,4]))
