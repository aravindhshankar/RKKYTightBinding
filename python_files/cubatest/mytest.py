...
if __name__ == '__main__':
    ...
    print_header('Vegas')
    print_results('Vegas', pycuba.Vegas(
        Integrand, NDIM, verbose=verbose, epsrel=1e-3))

    print_header('Suave')
    print_results('Suave', pycuba.Suave(Integrand, NDIM, NNEW,
                  NMIN, FLATNESS, verbose=verbose, epsrel=1e-3))
    ...
    print_header('Cuhre')
    print_results('Cuhre', pycuba.Cuhre(Integrand, NDIM,
                  key=KEY, verbose=verbose, epsrel=1e-6))
